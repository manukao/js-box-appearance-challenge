...
// add event listeners
inputColor.addEventListener("input", handleColorChange);
inputRadius.addEventListener("input", handleRadiusChange);
inputRotation.addEventListener("input", handleRotationChange);
...
function handleRadiusChange(event) {
  ...
  box.classList.toggle("circle", radius === "50");
}
